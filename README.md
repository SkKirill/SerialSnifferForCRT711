...
| sti | stj | Тип                                                                           |
|-----|-----|-------------------------------------------------------------------------------|
| 0   | 0   | Не активированно устройство считывания информации или не известная RFID-карта |
| 1   | 0   | Mifare one S50Card                                                            |
| 1   | 1   | Mifare one S70Card                                                            |
| 1   | 2   | Mifare one UL Card                                                            |
| 2   | 0   | Type A CPU Card                                                               |
...
---
## Активация устройства считывания информации с RFID карты и считывание id RFID карты

> Документация 4.7.1

> Команда:  `0xF2  'ADDR'  0x00  0x05  0x43  0x60  0x30  0x41  0x42  0x03  'BCC'`
> > PM=0x30 -> `0xF2  0x00  0x00  0x05  0x43  0x60  0x30  0x41  0x42  0x03  0xE4`

<details><summary> CRT возвращает text package</summary>

- **`CM` , `PM`** -> в нашем случае это `0x60  0x30`
- [st0](#st0), [st1](#st1), [st2](#st2)
- rType (1 byte), ATQA (2 byte)
- UID_Len (1 byte) -> длина id rfid карты
- UID_data (4-10 byte) -> сам id rfid карты
- SAK (1 byte)

</details>

---
## Выключение устройства считывания информации с RFID карты

> Документация 4.7.2

> Команда:  `0xF2  'ADDR'  0x00  0x03  0x43  0x60  0x31  0x03  'BCC'`  
> -> `0xF2  0x00  0x00  0x03  0x43  0x60  0x31  0x03  0xE0`  

<details><summary> CRT возвращает text package</summary>

- **`CM` , `PM`** -> в нашем случае это `0x60  0x31`
- [st0](#st0), [st1](#st1), [st2](#st2)
