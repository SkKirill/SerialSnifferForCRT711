...
public static class CommandListInfo
{
    ...
    public static readonly ByteCommand CommandCardMoveToFrontYes = new(
    ...
    public static readonly ByteCommand CommandCardMoveToFrontNo = new(
    ...
    public static readonly ByteCommand CommandRfidCardActivated = new(
        "4.7.1 Activated contactless IC card PM=0x30",
        [ValueStx, ValueAddr, 0x00, 0x03, ValueCmt, 0x60, 0x30, ValueEtx, 0x00]
    );
    
    public static readonly ByteCommand CommandRfidCardDeactivated = new(
    ...
    public static readonly ByteCommand CommandRfidCardSleep = new(
        "4.7.7 RFID card sleep operation PM=0x39 Set=30",
        [ValueStx, ValueAddr, 0x00, 0x04, ValueCmt, 0x60, 0x39, 0x30, ValueEtx, 0x00]
    );
    
    public static readonly ByteCommand CommandRfidCardWakeUp = new(
        "4.7.7 RFID card wake-up operation PM=0x39 Set=31",
